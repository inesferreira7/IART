...
inicio --> sintag_nominal(N, Suj), sintag_verbal(N, Acao, Obj, Suj), {responde(Suj, Acao, Obj)}

inicio(_,_):- retract(erroSem), write('Erro Semantico').

inicio(_,_):- write('Erro Sintaxe').
